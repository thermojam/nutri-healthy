...
export const metadata: Metadata = {
  title: "Политика конфиденциальности | Нутрициолог [Имя]",
  description:
        ...
        <article className="prose dark:prose-invert max-w-4xl mx-auto">
          ...
          <section>
            ...
            <p>
              ...
              которую сайт «Нутрициолог [Имя]» (далее — Сайт), расположенный по доменному имени https://yoursite.ru, 
              может получить о пользователе во время использования Сайта.
            </p>
            <p>
              Мы уважаем ваши права и обязуемся обрабатывать ваши персональные данные в соответствии с Федеральным законом 
          ...
          <section>
            ...
            <p>
              Обработка персональных данных осуществляется на территории Российской Федерации с соблюдением 
          ...
          <section>
            ...
            <p>
              Мы принимаем необходимые технические и организационные меры для защиты персональных данных от 
          ...
          <section>
            ...
            <p>
              Вы можете отозвать согласие на обработку персональных данных в любое время, направив уведомление 
              на электронную почту <a href="mailto:info@yoursite.ru" className="text-primary">info@yoursite.ru</a> или 
          ...
          <section>
            ...
            <p>
              Актуальная версия Политики всегда доступна на Сайте. Мы оставляем за собой право вносить изменения 
