...
export default function ContactSection({data}: ContactSectionProps) {
    ...
    const contactData = data || {
        title: "Начните свою трансформацию сейчас",
        subtitle: "Ваше здоровье не ждет — сделайте первый шаг",
        description:
            "Заполните форму, и я свяжусь с вами в течение 24 часов. " +
            "На бесплатной 15-минутной консультации мы определим вашу главную проблему " +
            "и я подскажу, как её решить. Это ни к чему не обязывает.",
        bonus:
            "🎁 Бонус за заявку: чек-лист «5 шагов к здоровому питанию» + гайд «Микробиом и энергия»!",
    };
