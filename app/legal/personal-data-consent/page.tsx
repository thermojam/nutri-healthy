...
export const metadata: Metadata = {
    title: "Согласие на обработку персональных данных | Ксения Каменская",
    description:
            ...
            <main className="container py-12">
                <article className="prose dark:prose-invert max-w-4xl mx-auto">
                    ...
                    <section>
                        ...
                        <p>
                            Настоящим я, далее «Субъект», даю свое согласие ИП Каменская Ксения (далее «Оператор») на обработку
